...
<head>
    ...
    <title>View Unavailable Processed Materials</title>
...
<body>
    ...
    <main class="main-content">
        <h2>Show Unavailable Processed Materials</h2>
        <table class="table table-striped">
            <thead>
                <tr>
                    <th>Sr. No.</th>
                    <th>Processed Material Id</th>
                    <th>Processed Material Name</th>
                </tr>
            </thead>
            <tbody>
                <% 
                List<ProcessedMaterial> rawMaterials = (List<ProcessedMaterial>) request.getAttribute("zeroQuantityMaterials");
               int i=1;
                    for (ProcessedMaterial material : rawMaterials) {  
                        if (material.getQuantity() == 0) { // Ensure quantity is zero
                %>
                        <tr>
