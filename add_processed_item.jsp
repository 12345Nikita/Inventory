    ...
    <main class="main-content">
        ...
        <form action="process" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" placeholder="Enter processed material name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="unit" name="unit" placeholder="Enter unit (e.g., kg, liter)">
            </div>
            <div class="form-group">
                <label for="cost_per_unit">Cost Per Unit</label>
                <input type="number" class="form-control" id="cost_per_unit" name="costPerUnit" placeholder="Enter cost per unit">
            </div>
