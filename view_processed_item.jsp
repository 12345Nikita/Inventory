...
<body>
    ...
    <main class="main-content">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <% 
                    List<ProcessedMaterial> pro = (List<ProcessedMaterial>) request.getAttribute("processedMaterials");
                    if (pro != null && !pro.isEmpty()) {
                        int serialNo = 1; // Initialize serial number
                        for (ProcessedMaterial c : pro) { 
                %>
                        <tr>
                            ...
                            <td><a href="deleteProcessed?id=<%= c.getId() %>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
                        </tr>
                <% 
                        } 
                    } else { 
