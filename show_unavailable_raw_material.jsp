...
<head>
    ...
    <title>View Unavailable Raw Materials</title>
...
<body>
    ...
    <main class="main-content">
        <h2>Show Unavailable Raw Materials</h2>
        <table class="table table-striped">
            ...
            <tbody>
                <% 
                List<RawMaterial> rawMaterials = (List<RawMaterial>) request.getAttribute("zeroQuantityMaterials");
               int i=1;
