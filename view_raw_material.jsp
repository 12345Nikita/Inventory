...
<body>
    ...
    <main class="main-content">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <% 
                    List<RawMaterial> raw = (List<RawMaterial>) request.getAttribute("rawMaterials");
                    if (raw != null && !raw.isEmpty()) {
                        int serialNo = 1; // Initialize serial number
                        for (RawMaterial c : raw) { 
                %>
                        <tr>
                            ...
                            <td><a href="deleteRaw?id=<%= c.getId() %>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
                        </tr>
                <% 
                        } 
                    } else { 
